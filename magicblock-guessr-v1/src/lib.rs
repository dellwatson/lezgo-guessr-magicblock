...
declare_id!("2MFSqZcmLpW5K4YzcyQbvXW31A3D68tv4ArdZqYQYzZD");

#[ephemeral]
#[program]
pub mod guessr_multiplayer_program_v1 {
    use super::*;
    ...
    pub fn enter_room(
        ...
        instructions::room::enter_room_handler(
            ctx,
            wallet_address,
            room_id,
            match_mode,
    ...
    pub fn commit_match_result_pool(
        ...
        instructions::profile::commit_match_result_pool_handler(
            ctx,
            wallet_address,
            match_mode,
            did_win,
    ...
    pub fn init_player_accounts(
        ...
        instructions::profile::init_player_accounts_handler(ctx, wallet_address)
    }
    ...
    pub fn mint_pool_reward(ctx: Context<MintPoolReward>, amount: u64) -> Result<()> {
        instructions::magic_actions::mint_pool_reward_handler(ctx, amount)
    }
    ...
    pub fn commit_pool_with_reward(
        ctx: Context<CommitPoolWithReward>,
        mint_amount: u64,
    ) -> Result<()> {
        instructions::commit_pool_with_reward_handler(ctx, mint_amount)
    }
}
